      ...
      <DialogContent className="bg-card border-border max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input value={form.aperture_suggestion} onChange={(e) => update('aperture_suggestion', e.target.value)} placeholder="e.g. f/1.8, ISO 100, 1/500s" className="bg-muted border-border font-dm text-sm" />
          </div>
