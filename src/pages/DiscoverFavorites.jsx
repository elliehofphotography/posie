...
export default function DiscoverFavorites() {
  ...
  const saveToAllPhotosMutation = useMutation({
    mutationFn: async (post) => {
      // "All Photos" means a template called "All Photos" or the first gallery — create a special shared one
      // We just create a TemplatePhoto with a special "all_photos" template id placeholder
      // Actually: we create a new gallery named "Saved from Discover" if none exists, or use first gallery
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => unfavoriteMutation.mutate(post.id)}
                      >
